...
const Search = () => {
	...
	return (
		<div className={ twMerge('relative w-full mx-auto md:pr-6 lg:max-w-[600px]', styles.search) }>
			<form className='w-full' onSubmit={ onSubmit }>
				<Input
					...
					classNames={ {
						...
						mainWrapper: 'h-full',
						input: 'text-[15px]',
						inputWrapper: 'h-full font-normal text-default-500 w-full pl-4 pr-0 rounded-full border-gray-300 bg-white focus:border-gray-200',
					} }
					value={ value }
